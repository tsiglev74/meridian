...
TREATMENT_PRIOR_TYPES = frozenset({
...
# LINT.ThenChange(
#     //depot/google3/ads/lift/mmm/schema/protos/model/meridian/meridian_model.proto,
#     //depot/google3/ads/lift/mmm/schema/serde/distribution.py,
# )
...
IGNORED_PRIORS_PAID_MEDIA = immutabledict.immutabledict({
    TREATMENT_PRIOR_TYPE_ROI: (
        BETA_M, BETA_RF, MROI_M, MROI_RF, CONTRIBUTION_M, CONTRIBUTION_RF
    ),
    TREATMENT_PRIOR_TYPE_MROI: (
        BETA_M, BETA_RF, ROI_M, ROI_RF, CONTRIBUTION_M, CONTRIBUTION_RF
    ),
    TREATMENT_PRIOR_TYPE_CONTRIBUTION: (
        BETA_M, BETA_RF, ROI_M, ROI_RF, MROI_M, MROI_RF
    ),
    TREATMENT_PRIOR_TYPE_COEFFICIENT: (
...
IGNORED_PRIORS_ORGANIC_MEDIA = immutabledict.immutabledict({
    TREATMENT_PRIOR_TYPE_CONTRIBUTION: (BETA_OM, BETA_ORF),
    TREATMENT_PRIOR_TYPE_COEFFICIENT: (CONTRIBUTION_OM, CONTRIBUTION_ORF),
})
