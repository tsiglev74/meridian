...
if TYPE_CHECKING:
  from google3.ads.lift.mmm.modeling.research.contr_priors.model import model  # pylint: disable=g-bad-import-order,g-import-not-at-top
  ...
  def _sample_media_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      beta_m_value = mmm.calculate_beta_x(
          random_effects_dist=mmm.media_effects_dist,
  ...
  def _sample_non_media_treatments_priors(
    ...
    if prior_type == constants.TREATMENT_PRIOR_TYPE_COEFFICIENT:
      ...
      gamma_n_value = mmm.calculate_beta_x(
          random_effects_dist=constants.MEDIA_EFFECTS_NORMAL,
